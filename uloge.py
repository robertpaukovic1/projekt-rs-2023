...
@app.post("/api/nova-uloga/", status_code=status.HTTP_201_CREATED)
...
@app.get("/api/uloge/", response_model=List[UlogaPydantic], status_code=status.HTTP_200_OK)
...
@app.get("/api/uloga/{u_id}", response_model=UlogaPydantic)
...
@app.put("/api/izmjena-tipa-uloge/{u_id}", status_code=status.HTTP_200_OK)
...
@app.get("/api/uloga_za_film/", response_model=List[FilmPydantic], status_code=status.HTTP_200_OK)
...
@app.get("/api/uloga_za_glumce/", response_model=List[GlumacPydantic], status_code=status.HTTP_200_OK)
