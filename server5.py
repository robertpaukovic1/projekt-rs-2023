...
def import_StudioPydantic():
    from server4 import StudioPydantic 
...
@app.get("/dohvati-filmska-studia-sa-cetvrtog-servera/", response_model=List[StudioPydantic], status_code=status.HTTP_200_OK)
...
@app.get("/dohvati-filmskih-uloga-sa-sestog-servera/", response_model=List[UlogaPydantic], status_code=status.HTTP_200_OK)
